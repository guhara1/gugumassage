...
const detailedServices = {
  ...
  aroma: {
    eyebrow: "Aroma Care",
    h1: "아로마 출장마사지 서비스 안내",
    title: "아로마 출장마사지 서비스 안내 | 향과 오일 중심 릴랙스 관리",
    description: "아로마 출장마사지의 특징, 추천 대상, 관리 방식, 이용 전 준비사항을 안내합니다. 은은한 오일과 부드러운 터치의 릴랙스 관리를 확인해 보세요.",
    intro: "아로마 관리는 은은한 오일과 부드러운 터치를 활용해 편안한 휴식감을 높이는 관리입니다. 향과 촉감을 통해 긴장을 낮추고 싶은 고객에게 적합하며, 피부 마찰을 줄여 보다 부드러운 흐름으로 전신을 관리합니다.",
    ...
    faq: [["아로마 관리는 오일을 사용하나요?", "네. 오일 사용이 가능하며 민감도가 있으면 예약 전 알려주시면 됩니다."], ["향이 강한가요?", "은은한 향을 기준으로 하며, 향이 부담스러운 경우 조절할 수 있습니다."], ["피부가 민감해도 가능한가요?", "민감한 피부라면 상담 단계에서 반드시 알려주세요. 상황에 따라 이용을 권하지 않을 수도 있습니다."], ["예약 전 무엇을 말해야 하나요?", "지역, 시간, 오일 선호도, 피해야 할 향이나 부위를 알려주시면 됩니다."]]
  },
  sports: {
    eyebrow: "Sports Care",
    h1: "스포츠 출장마사지 서비스 안내",
    title: "스포츠 출장마사지 서비스 안내 | 활동 후 근육 피로 관리",
    description: "스포츠 출장마사지의 특징, 추천 대상, 진행 방식, 이용 전 준비사항을 안내합니다. 활동량이 많은 고객을 위한 근육 피로 관리 정보를 확인해 보세요.",
    intro: "스포츠 관리는 운동, 장거리 이동, 현장 업무처럼 활동량이 많은 일정 뒤 몸의 무거움을 줄이는 데 초점을 둔 관리입니다. 특정 부위를 무리하게 자극하기보다 피로 부위와 활동 패턴을 확인해 압과 속도를 조절합니다.",
    ...
    faq: [["운동 직후 바로 받아도 되나요?", "컨디션에 따라 다릅니다. 과도한 피로, 통증, 부상 의심이 있으면 이용보다 휴식이나 의료 상담이 우선입니다."], ["압을 강하게 받을 수 있나요?", "가능한 범위에서 조절하지만 무리한 강압은 권하지 않습니다."], ["어떤 부위를 중심으로 하나요?", "어깨, 등, 허리, 하체 등 피로 부위를 상담에서 먼저 확인합니다."], ["출장 중 받을 수 있나요?", "지역과 시간, 방문 장소 조건을 확인한 뒤 가능 여부를 안내합니다."]]
  },
  couple: {
    eyebrow: "Couple Care",
    h1: "커플 출장마사지 서비스 안내",
